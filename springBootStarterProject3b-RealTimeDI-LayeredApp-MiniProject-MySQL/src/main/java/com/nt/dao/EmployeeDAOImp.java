...
//	private JdbcTemplate template;
	...
	public List<Employee> getEmpbyDesig(String s1, String s2, String s3) throws Exception {
		System.out.println("EmployeeDAOImp.getEmpbyDesig() DataSource obj class name "+ds.getClass());
		//System.out.println("DataSource obj class name class com.zaxxer.hikari.HikariDataSource");
